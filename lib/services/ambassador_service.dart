...
class AmbassadorService {
  static const String postUrl = "https://www.salondelapprentissage.ca/_functions/ambassadors"; 

  Future<List<dynamic>> fetchAmbassadors() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return data['ambassadors'] ?? []; // Retourne la liste des ambassadeurs
      } else {
        throw Exception("Erreur API Wix: ${response.body}");
      }
    } catch (e) {
      throw Exception("Erreur lors du chargement des ambassadeurs: $e");
    }
  }
}